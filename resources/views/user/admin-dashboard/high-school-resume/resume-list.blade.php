                    ...
                    <tbody>
                        ...
                        <tr class="resume_remove_{{ $resume->id }}">
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button class="btn btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg" data-bs-toggle="tooltip" title="Preview">
                                        <i class="fa fa-fw fa-file-pdf"></i>
                                    </button>
                                    <a href="{{ route('admin-dashboard.highSchoolResume.resume.download', ['id' => $resume->id, 'type' => 'download']) }}" class="btn btn-sm ms-2" data-bs-toggle="tooltip" title="Download">
                                        <i class="fa fa-fw fa-download"></i>
                                    </a>
                                    <form id="deleteResumeForm" onsubmit="deleteResume(this)" data-id="{{ $resume->id }}">
                                        <button type="submit" class="btn btn-sm ms-2" data-bs-toggle="tooltip" title="Delete">
