    ...
    <div class="container">
        <div class="custom-tab-container ">
                                ...
                                <div class="preview-rightside">
                                    @if(!empty($education))
                                        <div class="preview-list mb-3">
                                            <h3>Education</h3>
                                            <ul class="list">
                                                <li>{{ $education->high_school_name }} / {{ $education->high_school_city }} / {{ $education->high_school_state }}</li>
                                                <li>Weighted GPA: {{ isset($education->cumulative_gpa_weighted) ? $education->cumulative_gpa_weighted : '-' }}, Class Rank: {{ isset($education->class_rank) ? $education->class_rank : '-' }}</li>
                                        ...
                                        @if(!empty($employmentCertification->significant_data))
                                            <div class="preview-list mb-3">
                                                ...
                                                <ul class="list">
                                                    ...
                                                    @endphp
                                                    <li>{{ \App\Helpers\Helper::convertMultidimensionalToString($significant_data_arr, 'responsibility_interest', ', ') }}</li>
                                                </ul>
                                            </div>
                                        @endif
                                        @if(!empty($employmentCertification->employment_data))
                                            <div class="preview-list mb-3">
                                                ...
                                                <ul class="list">
                                                    ...
                                                    @endphp
                                                    <li>{{ \App\Helpers\Helper::convertMultidimensionalToString($employment_data_arr, 'job_title', ', ') }}</li>
                                                </ul>
                                            </div>
                                        @endif
                                    @endif
            ...
            <div class="d-flex justify-content-between mt-3">
                <div class="prev-btn">
                    <a href="{{ route('admin-dashboard.highSchoolResume.featuresAttributes') }}" class="btn btn-alt-primary next-step"> Previous
                    </a>
                </div>
                <div class="next-btn">
                    <div class="next-btn">
