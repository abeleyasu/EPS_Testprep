    ...
    <div class="container">
        <div class="custom-tab-container ">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li role="presentation">
                    <a class="nav-link active" href="{{ route('admin-dashboard.highSchoolResume.featuresAttributes') }}" id="step6-tab">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="setup-content">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <div class="prev-btn">
                                <a href="{{ route('admin-dashboard.highSchoolResume.employmentCertification') }}" class="btn btn-alt-primary next-step"> Prev
                                </a>
                            </div>
                            <div class="next-btn">
                                <a href="{{ route('admin-dashboard.highSchoolResume.preview') }}" class="btn btn-alt-primary next-step"> Next
                                </a>
                            </div>
                        </div>
                    </div>
