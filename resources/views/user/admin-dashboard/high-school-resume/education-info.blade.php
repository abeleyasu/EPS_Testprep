...
<main id="main-container">
    ...
    <div class="container education-container">
        <div class="custom-tab-container ">
            ...
            <form class="js-validation" action="{{ route('admin-dashboard.highSchoolResume.educationInfo') }}" method="POST">
                @csrf
                    ...
                    <div class="setup-content" role="tabpanel" id="step2" aria-labelledby="step2-tab">
                        <div class="accordion accordionExample2">
                                    ...
                                    <div class="block-content">
                                        <div class="main-form-input">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control form-drop @error('college_name') is-invalid @enderror" value="{{ old('college_name') }}" id="college_name" name="college_name" placeholder="Enter College name">
                                                @error('college_name')
                                                <span class="invalid">{{ $message }}</span>
                                                @enderror
                                                <div class="custom-dropdown-course">
                                                    <ul>
                                                        <li><a href="#">list</a></li>
                            ...
                            <div class="block block-rounded block-bordered overflow-hidden mb-1">
                                ...
                                <div id="collapseThree" class="collapse {{ $errors->first('cumulative_gpa_unweighted') || $errors->first('cumulative_gpa_weighted') || $errors->first('cumulative_gpa_unweighted') ? 'show' : '' }}" data-parent=".accordionExample2">
                                    <div class="block-content">
                                        <div class="main-form-input">
                                            <div class="mb-4">
                                                <label class="form-label" for="cumulative_gpa_unweighted">Cumulative GPA
                                    ...
                                    <div class="block-content">
                                        <div class="main-form-input">
                                            <div class="mb-4">
                                                ...
                                                <input type="number" class="form-control @error('class_rank') is-invalid @enderror" value="{{ old('class_rank') }}" id="class_rank" name="class_rank" placeholder="Enter Class Rank">
                                                @error('class_rank')
                                                <span class="invalid">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="main-form-input">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control @error('course_name') is-invalid @enderror" id="course_name" name="course_name" value="{{ old('course_name') }}" placeholder="Ex: Collage English 101">
                                                    @error('course_name')
                                                    <span class="invalid">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control form-college @error('college_id') is-invalid @enderror" value="{{ old('college_id') }}" id="College-Name" name="college_id" placeholder="Search College Name">
                                                    @error('college_id')
                                                    <span class="invalid">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <td class="td-course">Mark</td>
                                                            <td class="td-college">Mark</td>
                                                            <td>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control @error('honors_course_name') is-invalid @enderror" id="honors_course_name" value="{{ old('honors_course_name') }}" name="honors_course_name" placeholder="Ex: Collage English 101">
                                        ...
                                        <div class="main-form-input">
                                            <div class="row mb-2">
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control @error('name_of_test') is-invalid @enderror" value="{{ old('name_of_test') }}" id="name_of_test" name="name_of_test" placeholder="Enter Name of test">
                                                    @error('name_of_test')
                                                    <span class="invalid">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control @error('results_score') is-invalid @enderror" value="{{ old('results_score') }}" id="results_score" name="results_score" placeholder="Enter Results score">
                                                    @error('results_score')
                                                    <span class="invalid">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="col-lg-3">
                                                    ...
                                                    <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" value="{{ old('date') }}" name="date" placeholder="Enter Date">
                                                    @error('date')
                                                    <span class="invalid">{{ $message }}</span>
                                                    @enderror
                                                </div>
                            ...
                            <div class="d-flex justify-content-between mt-3">
                                <div class="prev-btn">
                                    <a href="{{ route('admin-dashboard.highSchoolResume.personalInfo') }}" class="btn btn-alt-primary next-step"> Prev
                                    </a>
                                </div>
                                <div class="next-btn">
                                    <div class="next-btn">
