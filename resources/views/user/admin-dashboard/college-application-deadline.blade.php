                    ...
                    <tbody class="fs-sm">
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold fs-sm">
                                <div class="row">
                                    <div class="col-6">
                                        <label class="form-label" for="example-select">Competitive Scholarship
                                            Deadline</label>
                                        <input type="text" class="js-datepicker form-control" id="example-datepicker1"
                                            name="example-datepicker1" data-week-start="1" data-autoclose="true"
                                            data-today-highlight="true" data-date-format="mm/dd/yy"
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold fs-sm">
                                <div class="row">
                                    <div class="col-6">
                                        <label class="form-label" for="example-select">Departmental/STEM Scholarship
                                            Deadline</label>
                                        <input type="text" class="js-datepicker form-control" id="example-datepicker1"
                                            name="example-datepicker1" data-week-start="1" data-autoclose="true"
                                            data-today-highlight="true" data-date-format="mm/dd/yy"
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label mb-3" for="row_1"><b>Application Checklist Complete
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Request & pay for test scores (if
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Request your official high school
                                        transcripts
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Pay the high school transcript
                                        submittal fee
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Request letters of recommedation from
                                        your
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Confirm that your official high school
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Confirm that the school report and
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Confirm that your test scores have been
                                        sent</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Confirm that your letters of
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">After you submit your application, set
                                        up your student portal to confirm that the college has received your application and
                                        required documentation (Usually the college will send you an email with directions
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1"><b>Application Checklist
                                            Complete</b></label>
                                    <!-- This checkbox should populate/be checked ONLY once all of other checkboxes are checked -->
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Request & Pay for Test Scores to be
                                        sent to the
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Official High School Transcript
                                        Received by the
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Secondary School Reports or Counselor
                                        Recommendations (Sent by Counseling Office)</label>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="checkbox" value="" id="row_1"
                                        name="row_1">
                                    <label class="form-check-label" for="row_1">Letters of Recommendation (Sent by
                                        Recommenders)</label>
                                </div>
                            </td>
