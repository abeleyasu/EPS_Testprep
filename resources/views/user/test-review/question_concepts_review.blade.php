                    ...
                    <div class="container position-fixed">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <div class="text-end">
                                    <button type="button"
                                        class="generate_custom_quiz generate_custom_quiz_two btn btn-primary fs-xs fw-semibold"
                                ...
                                <div class="container position-fixed">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-end">
                                            <div class="text-end">
                                                <button type="button"
                                                    class="generate_custom_quiz generate_custom_quiz_one btn btn-primary fs-xs fw-semibold"
                                                    data-bs-trigger="click">Generate
                                                    Custom Quiz</button>
                                            </div>
                                        </div>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                @php
                                                                                    ...
                                                                                    // dd($single_user_selected_answers['user_selected_answer']);
                                                                                @endphp
                                                                                @foreach ($category_type_arr as $key => $category_type)
                                                                                    @if (strtolower($key) == $single_user_selected_answers['user_selected_answer'])
                                                                                            ...
                                                                                            <tr class="odd">
                                                                                                ...
                                                                                                <td>
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            class="form-check-input add_to_custom_quiz"
                                                                                                            type="checkbox"
                                                ...
                                                <div class="accordion accordionExample">
                                                    ...
                                                    @foreach ($store_all_data as $get_question_type => $single_question_data)
                                                        ...
                                                        <div
                                                            ...
                                                            <div id="collapseOne_<?php echo $test; ?>" class="collapse"
                                                                aria-labelledby="headingOne"
                                                                data-parent=".accordionExample">
                                                                <div class="odd">
