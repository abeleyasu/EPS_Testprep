            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item" aria-current="page">
                        <a class="link-fx" href="{{ url('user/practice-test-sections/'.$testSection[0]->testid) }}">College Prep System {{ isset($testSection[0]->section_title) ? $testSection[0]->section_title : '' }} {{ isset($testSection[0]->title) ? $testSection[0]->title : '' }} {{ isset($testSection[0]->id) ? '#'. $testSection[0]->id : '' }}</a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">
