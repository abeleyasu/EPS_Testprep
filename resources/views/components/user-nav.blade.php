    ...
    <div class="js-sidebar-scroll">
        ...
        <div class="content-side">
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ Route::is('user-dashboard') ? 'active' : '' }}"
                ...
                <li
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ route('courses.index') }}">
                                <i class="nav-main-link-icon si si-book-open"></i>
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ Route::is('rewards.*') ? 'active' : '' }}"
