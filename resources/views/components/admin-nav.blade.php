        ...
        <div class="content-side">
            <ul class="nav-main">
                <li class="nav-main-item">
                    <a class="nav-main-link {{ Route::is('admin-dashboard') ? 'active' : '' }}"
                ...
                <li
                    class="nav-main-item {{ Route::is('admin-user-list') || Route::is('admin-edit-user') || Route::is('admin-create-user') ? 'open' : '' }}">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is('admin-user-list') ? 'active' : '' }}"
                                href="{{ route('admin-user-list') }}">
                                <span class="nav-main-link-name">User List</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is('admin-create-user') ? 'active' : '' }}"
                ...
                <li
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is(['custom-quizzes.index', 'passages.show']) ? 'active' : '' }}"
                                href="{{ route('custom-quizzes.index') }}">
                                <span class="nav-main-link-name">Custom Quiz</span>
                            </a>
                        </li>
                    </ul>
                    <ul class="nav-main-submenu">
                    ...
                    <ul class="nav-main-submenu">
                        <li
                            class="nav-main-item {{ Route::is(['quiztags.index', 'quiztags.create', 'quiztags.edit', 'categories.index', 'categories.create', 'categories.edit']) ? 'open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="true" href="#">
                ...
                <li
                    class="nav-main-item {{ Route::is(['admin.highSchoolResume.*', 'admin.admission-management.*']) ? 'open' : '' }}">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        aria-expanded="true" href="#">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is('admin.highSchoolResume.settings') ? 'active' : '' }}"
                                href="{{ route('admin.highSchoolResume.settings') }}">
                                <span class="nav-main-link-name">High School Resume Settings</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link {{ Route::is('admin.admission-management.college-information.index') ? 'active' : '' }}"
                                href="{{ route('admin.admission-management.college-information.index') }}">
                ...
                <li
                    class="nav-main-item {{ Route::is(['admin.category.*', 'admin.plan.*', 'admin.product.*']) ? 'open' : '' }}">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        aria-expanded="true" href="#">
                        <i class="nav-main-link-icon fas fa-cogs"></i>
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item {{ Route::is(['admin.category.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.category.list') ? 'active' : '' }}"
                        ...
                        <li class="nav-main-item {{ Route::is(['admin.product.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.product.list') ? 'active' : '' }}"
                        ...
                        <li class="nav-main-item {{ Route::is(['admin.plan.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.plan.list') ? 'active' : '' }}"
                                href="{{ route('admin.plan.list') }}">
                                <span class="nav-main-link-name">Plan Management</span>
                            </a>
                        </li>
                        <li class="nav-main-item {{ Route::is(['admin.product.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.product.permission') ? 'active' : '' }}"
                                href="{{ route('admin.product.permission') }}">
                ...
                <li class="nav-main-item {{ Route::is(['admin.worksheet-management.*']) ? 'open' : '' }}">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item {{ Route::is(['admin.worksheet-management.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.worksheet-management.index') ? 'active' : '' }}"
                                href="{{ route('admin.worksheet-management.index') }}">
                ...
                <li class="nav-main-item {{ Route::is(['admin.roles.*', 'admin.permissions.*']) ? 'open' : '' }}">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item {{ Route::is(['admin.roles.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.roles.index') ? 'active' : '' }}"
                                href="{{ route('admin.roles.index') }}">
                                <span class="nav-main-link-name">Roles</span>
                            </a>
                        </li>
                        <li class="nav-main-item {{ Route::is(['admin.permissions.*']) ? 'open' : '' }}">
                            <a class="nav-main-link {{ Route::is('admin.permissions.index') ? 'active' : '' }}"
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ Route::is('admin.subscription.*') ? 'active' : '' }}"
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link {{ Route::is('admin.setting.*') ? 'active' : '' }}"
