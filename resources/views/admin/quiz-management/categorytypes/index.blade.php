                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full hidden custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $singlecategoryType->format }}</td>
                            <td class="fs-sm">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="btn btn-sm btn-alt-secondary"> <input type="checkbox" class="teble-checkBox category mt-1" value="{{ $singlecategoryType->id }}" @if ($singlecategoryType->selfMade == 1) checked @endif></div>
                                </div>
                            </td>
                        </tr>
                        @endforeach
...
@section('admin-script')
    ...
    $(document).on('change','.category',function(){
        ...
        if($(this).is(':checked')){
            ...
            $.ajax({
            type: 'post',
            url: '{{ route("removeSelfMadeCategory") }}',
            data:{
                searchValue: category_id,
                '_token': $('input[name="_token"]').val()
            },
