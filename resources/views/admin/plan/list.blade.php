            ...
            <div class="block-content block-content-full">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th class="" style="width: 30%;">Plan key</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-semibold fs-sm">{{ $plan->name }}</td>
                            <td class="fs-sm">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{route('admin.plan.plan_update_show', ['id' => $plan->id])}}" class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title="Edit User">
