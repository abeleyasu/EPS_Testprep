                                ...
                                <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                                    ...
                                    <form class="js-validation-signup" id="register" action="{{route('post-signup')}}" method="POST" autocomplete="off">
                                        ...
                                        <div class="py-3">
                                            ...
                                            <div class="mb-4">
                                                <div class="form-check">
                                                    <input class="form-check-input {{$errors->has('is_verifed') ? 'is-invalid' : ''}}" type="checkbox" id="is_verifed" name="is_verifed">
                                            ...
                                            <div class="mb-4">
                                                <div class="form-check">
                                                    <input class="form-check-input {{$errors->has('is_receive_emails_newsletters') ? 'is-invalid' : ''}}" type="checkbox" id="is_receive_emails_newsletters" name="is_receive_emails_newsletters">
