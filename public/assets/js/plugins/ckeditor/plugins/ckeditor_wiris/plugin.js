        ...
        !(function () {
            ...
            (haxe.Log = function () {}),
                ...
                (haxe.Md5.prototype = {
                    ...
                    cmn: function (e, t, n, i, o, r) {
                        return this.addme(
                            this.rol(
                                this.addme(this.addme(t, e), this.addme(i, r)),
                                o
                            ),
                            n
                        );
            ...
            (js.Boot = function () {}),
                ...
                (js.Boot.__cast = function (e, t) {
                    ...
                    throw (
                        "Cannot cast " + Std.string(e) + " to " + Std.string(t)
                    );
                }),
                (js.Lib = function () {}),
                (js.Lib.__name__ = !0),
                ...
                (haxe.Log = function () {}),
                    ...
                    (haxe.Timer.measure = function (e, t) {
                        var n = haxe.Timer.stamp(),
                            i = e();
                        return (
                            haxe.Log.trace(haxe.Timer.stamp() - n + "s", t), i
                        );
                    }),
                    (haxe.Timer.stamp = function () {
                        return new Date().getTime() / 1e3;
                ...
                (js.Boot = function () {}),
                    ...
                    (js.Boot.__interfLoop = function (e, t) {
                        ...
                        if (null != n)
                            for (var i = 0, o = n.length; i < o; ) {
                                var r = n[i++];
                                if (r == t || js.Boot.__interfLoop(r, t))
                                    return !0;
                            }
                        return js.Boot.__interfLoop(e.__super__, t);
                    }),
            ...
            for (var n = 0; n < e.length; n++) {
                ...
                if (r) {
                    ...
                    for (; a < o.parts.length; a++)
                        r.parts.push(p(o.parts[a], t));
                } else {
                    var s = [];
                    for (a = 0; a < o.parts.length; a++)
                        s.push(p(o.parts[a], t));
    ...
    function (e, t, n) {
                ...
                (function (e, t, n) {
                        ...
                        value: function (e) {
                            ...
                            "_wrs_blackboard" in window &&
                                ...
                                (e = (e = (e = e
                                    .split(a)
                                    .join(
                                        o.safeGoodBlackboardCharacters.ltElement
                                    ))
                                    .split(s)
                                    .join(
                                        o.safeGoodBlackboardCharacters.gtElement
                                    ))
                                    .split(l)
                                    .join(
                                        o.safeGoodBlackboardCharacters
                                            .ampElement
                                    )),
                    ...
                    },
                    {
                        ...
                        value: function (t, n) {
                            ...
                            if (-1 !== r) {
                                for (
                                    var a = !1, s = t.indexOf("<annotation");
                                    -1 !== s;
                        ...
                        value: function (e) {
                            for (
                                var t =
                                    ...
                                    i = ""
                                        .concat(t.tagOpener, "/math")
                                        .concat(t.tagCloser),
                                    r = "/".concat(t.tagCloser),
                                    a = t.tagCloser,
                                    s = ""
                                        .concat(t.tagOpener, "semantics")
                                        .concat(t.tagCloser),
                                    l = "".concat(
                                        t.tagOpener,
                                        "annotation encoding="
                            ...
                            for (
                                ...
                                if (
                                    ...
                                    -1 === (f = t.indexOf(u, m))
                                        ...
                                        : (f += u.length),
                                    -1 !==
                                        (r = (i = t.substring(m, f)).indexOf(
                                            d
                                        )))
                                ) {
                                    (r += d.length), (s = i.indexOf(h));
                                    var g = i.substring(r, s);
                                    n === o.safeXmlCharacters &&
                                        (g = a.safeXmlDecode(g)),
                                        (l += "$$".concat(g, "$$")),
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n) {
                            ...
                            do {
                                if (
                                    null ==
                                        (i = r(l.node, l.position, n.open)) ||
                                    a(e, t, i.node, i.position)
                                )
                                    return null;
                                if (
                                    null ==
                                    (l = r(i.node, i.position + c, n.close))
                                )
                                    return null;
                                l.position += c;
                            } while (a(l.node, l.position, e, t));
                            if (i.node === l.node)
                                s = i.node.nodeValue.substring(
                                    i.position + c,
                                    l.position - c
                                );
                            else {
                ...
                })(e, null, [
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                t in this.strings ||
                                    (console.warn(
                                        "Unknown language ".concat(
                                            t,
                                            " set in StringManager."
                                        )
                                    ),
                                    (t = "en")),
                                e in this.strings[t]
                ...
                (function (e, t, n) {
                    ...
                    },
                    {
                        ...
                        value: function (t, n) {
                            ...
                            for (i = 0; i < a; i += 1) {
                                var s =
                                    e.fixedCharCodeAt(t, i) -
                                    e.fixedCharCodeAt(n, i);
                                if (0 !== s) return s;
                            }
                            ...
                            if (
                                ...
                                if (r.parentElement) {
                                    ...
                                    return (
                                        ...
                                        l.nextSibling &&
                                        3 === l.nextSibling.nodeType
                                            ? ((a = l.nextSibling), (s = 0))
                                            : l.previousSibling &&
                                              3 === l.previousSibling.nodeType
                                            ? (s = (a = l.previousSibling)
                                                  .nodeValue.length)
                                            : ((a =
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, i) {
                            ...
                            (e.value =
                                o + t + e.value.substring(i, e.value.length)),
                                (e.selectionEnd = n + t.length);
                        },
                    },
                    {
                            ...
                            if (
                                ...
                                if ("svg" === l.get("imageFormat")) {
                                    var n = decodeURIComponent(
                                        t.src.substring(32, t.src.length)
                                    );
                                    e.setImgSize(t, n, !0);
                                } else {
            ...
            return (
                (function (e, t, n) {
                ...
                })(e, null, [
                    {
                        ...
                        value: function (t, n, i) {
                            void 0 === n && (n = "en"),
                                a.containClass(t, "wrs_chemistry") &&
                                    (i.mode = "chemistry");
                            var o = "";
                            if (e.cache.get(t)) o = e.cache.get(t);
                                ...
                                "error" !== r.status
                                    ? ((o = r.result.text),
                                      e.cache.populate(t, o))
                                    : (o = b.get(
                                          "error_convert_accessibility"
                                      ));
                            }
                            return o;
                        },
                        ...
                        value: function (t, n, i, o) {
                            ...
                            if (
                                ...
                                (c = (c = c.substring(
                                    0,
                                    c.indexOf('"')
                                )).substring(4, c.length)),
                                    r.setAttribute(
                                        l.get("imageCustomEditorName"),
                                        c
                                    );
                            }
                            if (
                                ...
                                if ("warning" === d.status)
                                    try {
                                        d = JSON.parse(
                                            f.getService("showimage", s)
                                        );
                                    } catch (e) {
                                        return null;
                                    }
                                "png" === (d = d.result).format
                                    ? (r.src = "data:image/png;base64,".concat(
                                          d.content
                                      ))
                                    : (r.src =
                                          "data:image/svg+xml;charset=utf8,".concat(
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            if (-1 !== l.get("parseModes").indexOf("latex"))
                                for (
                                    var t = w.getElementsByNameFromString(
                                            e,
                                            "img",
                                            !0
                                        ),
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            return (
                                ...
                                (o.formula =
                                    com.wiris.js.JsPluginTools.md5encode(
                ...
                (function (e, t, n) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    this.editor.insertInto(
                                        this.modalDialogInstance
                                            .contentContainer
                                    ),
                                    this.editor.focus(),
                                    this.modalDialogInstance.rtl &&
                                        this.editor.action("rtl"),
                                    this.editor.getEditorModel().isRTL() &&
                                        (this.editor.element.style.direction =
                                            "rtl"),
                                    this.editor
                                        .getEditorModel()
                                        .addEditorListener(this.editorListener),
                                    this.modalDialogInstance.deviceProperties
                                        .isIOS)
                                ) {
                                    setTimeout(function () {
                                ...
                                setTimeout(
                                    e.prototype.insertEditor.bind(this),
                                    100
                                );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var n = this;
                            void 0 === t && (t = !1),
                                this.editor.setMathMLWithCallback(
                                    e,
                                    function () {
                                        n.editorListener.setWaitingForChanges(
                                            !0
                                        );
                                    }
                                ),
                            ...
                            if (this.editor.isFormulaEmpty())
                                ...
                                if (
                                    ...
                                    Object.keys(
                                        ...
                                        e = a.removeCustomEditorClassAttribute(
                                            e,
                                            t
                                        );
                                    });
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                "general" === e &&
                                    (e =
                                        "undefined" ==
                                            typeof _wrs_int_wirisProperties ||
                                        void 0 ===
                                            _wrs_int_wirisProperties.toolbar
                                            ? "general"
                                            : _wrs_int_wirisProperties.toolbar),
        ...
        var F = (function () {
            function e(t) {
                ...
                var o = this.overlayWrapper.appendChild(
                    document.createElement("div")
                );
            ...
            return (
                X(e, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.titleBar.appendChild(this.closeDiv),
                                ...
                                this.buttonContainer.appendChild(
                                    this.submitButton
                                ),
                                this.buttonContainer.appendChild(
                                    this.cancelButton
                    ...
                    },
                    {
                        ...
                        value: function () {
                            (this.resizerBR = document.createElement("div")),
                                (this.resizerBR.className =
                                    "wrs_bottom_right_resizer"),
                                (this.resizerBR.innerHTML = "◢"),
                                (this.resizerTL =
                                    document.createElement("div")),
                                (this.resizerTL.className =
                                    "wrs_bottom_left_resizer"),
                        ...
                        value: function () {
                            this.websiteBeforeLockParameters = {
                                ...
                                bodyStyleOverflow: document.body.style.overflow
                                    ...
                                    : "",
                                htmlStyleOverflow: document.documentElement
                                    .style.overflow
                        ...
                        value: function () {
                            this.addClass("wrs_modal_android"),
                                window.addEventListener(
                                    "resize",
                                    this.orientationChangeAndroidSoftkeyboard.bind(
                                        this
                                    )
                                );
                        },
                    },
                    {
                        ...
                        value: function () {
                            this.addClass("wrs_modal_ios"),
                                window.addEventListener(
                                    "resize",
                                    this.orientationChangeIosSoftkeyboard.bind(
                                        this
                                    )
                                );
                        },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            "stack" === this.properties.state
                                ? ((this.resizerTL.style.visibility =
                                      "visible"),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            if (this.dragDataObject) {
                                ...
                                var i = "".concat(
                                        n - this.dragDataObject.x,
                                        "px"
                                    ),
                                    o = "".concat(
                                        t - this.dragDataObject.y,
                                        "px"
                                    );
                            ...
                            if (this.resizeDataObject) {
                                ...
                                l < 0 && (l = 0),
                                    ...
                                    (this.container.style.width = "".concat(
                                        this.initialWidth +
                                            r * (l - this.resizeDataObject.x),
                                        "px"
                                    )),
                                    (this.container.style.height = "".concat(
                                        this.initialHeight +
                                            r * (c - this.resizeDataObject.y),
                                        "px"
                                    )),
                                    this.leftScale ||
                                        (this.resizeDataObject.x -
                                            l -
                                            this.initialWidth <
                                        -580
                                            ? (this.container.style.right =
                                            ...
                                            : ((this.container.style.right =
                                              ...
                                              (this.container.style.width =
                                                  "580px")),
                                        this.resizeDataObject.y - c <
                                        this.initialHeight - 338
                                            ? (this.container.style.bottom =
                                                  "".concat(
                                                      this.initialBottom -
                                                          (c -
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            void 0 !== e.key &&
                                ("block" !==
                                this.popup.overlayWrapper.style.display
                                    ? "Escape" === e.key || "Esc" === e.key
                                        ? this.properties.open &&
                    ...
                    },
                    {
                        ...
                        value: function () {
                            this.iosSoftkeyboardOpened ||
                                ...
                                this.iosDivHeight !==
                                    "100".concat(this.iosMeasureUnit) ||
                                (this.portraitMode()
                                    ? this.setContainerHeight(
                                          "63".concat(this.iosMeasureUnit)
                                      )
                                    : this.setContainerHeight(
                                          "40".concat(this.iosMeasureUnit)
                                      )),
        ...
        var J = (function () {
            function e(t) {
                ...
                if (
                    ...
                    throw new Error(
                        "serviceProviderProperties property missing."
                    );
                            ...
                            value: function () {
                                ...
                                if (e.initialized)
                                    ...
                                    var n = h.newListener(
                                        ...
                                        function () {
                                            var e =
                                                    '{"versionPlatform": "unknown","editorParameters": {},"imageFormat": "svg","CASEnabled": false,"customHeaders": "","parseModes": ["latex"],"editorToolbar": "","editorAttributes": "width=570, height=450, scroll=no, resizable=yes","base64savemode": "default","modalWindow": true,"version": "8.3.1.1466","enableAccessibility": true,"saveMode": "xml","saveHandTraces": false,"editorUrl": "http://www.wiris.net/demo/editor/editor","editorEnabled": true,"chemEnabled": true,"CASMathmlAttribute": "alt","CASAttributes": "width=640, height=480, scroll=no, resizable=yes","modalWindowFullScreen": false,"imageMathmlAttribute": "data-mathml","hostPlatform": "unknown","wirisPluginPerformance": true}',
                                                n = JSON.parse(e);
                            ...
                            value: function (e, t, n, i) {
                                ...
                                if (n)
                                    if ("latex" === this.editMode) {
                                        if (
                                            ((o.latex =
                                                p.getLatexFromMathML(n)),
                                            this.integrationModel
                                                .fillNonLatexNode && !o.latex)
                                        ) {
                                            var r = new N();
                                            ...
                                            o.node = t.document.createTextNode(
                                                "$$".concat(o.latex, "$$")
                                            );
                                ...
                                if (this.editionProperties.isNewElement)
                                    if (e)
                                        if ("textarea" === t.type)
                                            ...
                                            if (
                                                ...
                                                "IMG" ===
                                                o.nodeName.toUpperCase()
                                                    ? o.parentNode.replaceChild(
                                                          e,
                                                          o
                                                      )
                                                    : i.pasteHTML(
                                                          w.createObjectCode(e)
                                                      );
                                            }
                                        } else {
                                            var r =
                                    ...
                                    0 === document.getSelection
                                        ...
                                        : (this.editionProperties.latexRange.deleteContents(),
                                          this.editionProperties.latexRange.insertNode(
                                              e
                                          ),
                                          this.placeCaretAfterNode(e));
                                    ...
                                    (d =
                                        void 0 !==
                                        this.integrationModel.getSelectedItem
                                            ? this.integrationModel.getSelectedItem(
                                                  t,
                                                  !1
                                              )
                            ...
                            value: function (e, t) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                var s =
                                                    this.integrationModel.getMathmlFromTextNode(
                                                        n.node,
                                                        n.caretPosition
                                                    );
                                                s &&
                                                    ...
                                                    this.editionProperties.temporalImage.setAttribute(
                                                        l.get(
                                                            "imageMathmlAttribute"
                                                        ),
                                                        a.safeXmlEncode(s)
                                                    ));
                                            } else {
                                                var c = p.getLatexFromTextNode(
                                                    n.node,
                                                    n.caretPosition
                                                );
                                                if (c) {
                                                    var u =
                                                        p.getMathMLFromLatex(
                                                            c.latex
                                                        );
                                                    (this.editMode = "latex"),
                                                        (this.editionProperties.isNewElement =
                                ...
                                if (
                                    ...
                                    this.contentManager.addListener(T),
                                        ...
                                        this.modalDialog.setContentManager(
                                            this.contentManager
                                        ),
                                ...
                                this.contentManager.setIntegrationModel(
                                    this.integrationModel
                                ),
        ...
        (window.wrs_addPluginListener = function (e) {
            ...
            (window.wrs_initParse = function (e, t) {
                return (
                    console.warn(
                        "Deprecated method. Use Parser.endParse instead."
                    ),
                    E.initParse(e, t)
                );
            }),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (void 0 === this.scriptName)
                                throw new Error(
                                    "scriptName property needed for getPath."
                                );
                            for (
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            (this.target = e),
                                (this.isIframe =
                                    "IFRAME" ===
                                    this.target.tagName.toUpperCase());
                        },
                    },
                    {
                        key: "setEditorObject",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            this.editorParameters &&
                                (e =
                                    com.wiris.editor.util.EditorUtils.addAnnotation(
                                        e,
                        ...
                        value: function (e) {
                            if ("img" === e.nodeName.toLowerCase()) {
                                ...
                                w.containsClass(e, l.get("imageClassName")) &&
                                    ((this.core.editionProperties.temporalImage =
                                        e),
                                    (this.core.editionProperties.isNewElement =
                                        !0),
            ...
            return (
                ...
                (function (e, t, n) {
                    ...
                    },
                    {
                        key: "getPath",
                        value: function () {
                            return this.editorObject.plugins.ckeditor_wiris
                                .path;
                        },
                    },
                    {
                                  ...
                                  e.on(
                                      ...
                                      function () {
                                          e.on(
                                              ...
                                              function (e) {
                                                  (("img" ==
                                                      e.data.element.$.nodeName.toLowerCase() &&
                                                      w.containsClass(
                                                          e.data.element.$,
                                                          l.get(
                                                              "imageClassName"
                    ...
                    },
                    {
                        key: "getCorePath",
                        value: function () {
                            return CKEDITOR.plugins.getPath(
                    ...
                    },
                    {
                        key: "callbackFunction",
                        value: function () {
                            q(G(t.prototype), "callbackFunction", this).call(
                                this
                            ),
            ...
            init: function (e) {
                ...
                (t += l.get("imageMathmlAttribute")),
                    ...
                    e.on("instanceReady", function () {
                        var t = {};
                        (t.editorObject = e),
                            (t.target = e.container.$.querySelector(
                                "*[class^=cke_wysiwyg]"
                            )),
                            (t.serviceProviderProperties = {}),
                            ...
                            "mathTypeParameters" in e.config &&
                                (t.integrationParameters =
                                    e.config.mathTypeParameters);
                        var n = new ee(t);
                        n.init(),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            console.log("Testing configuration service..."),
                                console.log(
                                    f.getService("configurationjs", "", "get")
                                ),
                                ...
                                ((e = []).mml =
                                    '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>'),
                                console.log(
                                    f.getService("createimage", e, "post")
                                ),
                                ...
                                console.log(f.getService("service", e)),
                                console.log(
                                    "Testing Mathml2Accesible service..."
                                ),
